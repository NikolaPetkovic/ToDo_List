                    ...
                    for (int j = 0; j < dataTasks.get(i).gettagIdList().size(); j++) {
                        for (int k = 0; k < dataTags.size(); k++) {
                            if (dataTasks.get(i).gettagIdList().get(j) == dataTags.get(k).getId()){
                                if (j == 0){
                                    g.drawString("Tags:     " + dataTags.get(k).getName(), 10, 46 + i * 90);
                                } else {
                                    g.drawString("          " + dataTags.get(k).getName(), 10, 46 + i * 90  + j * 10);
                                }
                            }
                        }
                    }
                ...
                if (dataTasks.get(i).gettagIdList().size() == 0){
                    ...
                    for (int j = 0; j < dataTasks.get(i).gettagIdList().size(); j++) {
                        for (int k = 0; k < dataTags.size(); k++) {
                            if (dataTasks.get(i).gettagIdList().get(j) == dataTags.get(k).getId()){
                                if (j == 0){
                                    g.drawString("Tags:     " + dataTags.get(k).getName(), move1, 46 + (i-9) * 90);
                                } else {
                                    g.drawString("          " + dataTags.get(k).getName(), move1, 46 + (i-9) * 90  + j * 10);
                                }
                            }
                        }
                    }
                ...
                if (dataTasks.get(i).gettagIdList().size() == 0){
                    ...
                    for (int j = 0; j < dataTasks.get(i).gettagIdList().size(); j++) {
                        for (int k = 0; k < dataTags.size(); k++) {
                            if (dataTasks.get(i).gettagIdList().get(j) == dataTags.get(k).getId()){
                                if (j == 0){
                                    g.drawString("Tags:     " + dataTags.get(k).getName(), move2y, 46 + move2x);
                                } else {
                                    g.drawString("          " + dataTags.get(k).getName(), move2y, 46 + move2x + j * 10);
                                }
                            }
                        }
                    }
